        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="table-wrapper">
                <div class="sl-page-title d-flex justify-content-end">
                    <a type="button" href="{{route('add-subcategory',['id'=>$parent_id])}}" class="btn btn-success">Add Sub Category</a>
                </div>
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('edit-subcategory',['id'=>$category->id])}}"  class="btn btn-success">Edit</a>
                                <a href="#" id="{{$category->id}}" class="btn btn-danger"
                                    ...
                                    >Delete</a>
                                    <form id="deleteCategoryForm{{$category->id}}" action="{{route('delete-subcategory')}}" method="post">
                                        @csrf
