							...
							<div class="wt-userlistinghold wt-featured wt-userlistingvtwo">
								...
								<div class="wt-userlistingcontent">
									<div class="wt-contenthead">
										<div class="wt-title">
											<a href="usersingle.html"><i class="fa fa-check-circle"></i>adsd<!-- {{Session::get('buyer_name')}} -->
											</a>
											<h2>{{$job->title}}</h2>
										</div>
										<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
											...
											<li><span class="wt-dashboradclock">{{ \Carbon\Carbon::parse($job->created_at)->diffForHumans()}}</span></li>															
										</ul>
									</div>
									<div class="wt-rightarea">
										<div class="wt-btnarea">
											...
											@if($job->status==0)
											<a href="{{route('cancel-bid',['id'=>$job->proposal_id])}}" class="wt-btn" onclick="return confirm('Are you sure to cancel this bid?')">Cancel Bid</a>
											@elseif($job->status==1)
											<p class="text-danger">Hired Someone</p>
											
											@endif
										</div>
										<div class="wt-hireduserstatus">

											<h4>{{$job->proposals}}</h4><span>Proposals</span>
