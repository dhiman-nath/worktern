						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 d-flex justify-content-center">
							<div class="wt-jobalerts">
								<div class="alert alert-danger alert-dismissible fade show">
									<em>Error!</em> <span>{{Session::get('message')}}</span>
									<a href="javascript:void(0)" data-dismiss="alert" class="wt-alertbtn danger">Got It</a>
							...
							<div class="wt-userlistingholder wt-haslayout">
								...
								<!-- <div class="wt-userlistinghold wt-featured wt-userlistingholdvtwo">
									...
									<div class="wt-userlistingcontent">
										...
										<div class="wt-viewjobholder">
											<ul>
												<li><span><i class="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
												<li><span><em><img src="{{asset('/')}}assets/images/flag/img-02.png" alt="img description"></em>United States</span></li>
								...
								<div class="wt-userlistinghold wt-featured wt-userlistingholdvtwo">
									...
									<div class="wt-userlistingcontent">
										<div class="wt-contenthead">
											<div class="wt-title">
												<a href="usersingle.html"><i class="fa fa-check-circle"></i> {{$row->name}}</a>
												<h2>{{$row->title}}</h2>
											</div>
											<div class="wt-description">
												<p>{{$row->description}}</p>
										...
										<div class="wt-viewjobholder">
											<ul>
												<li><span><i class="fa fa-dollar-sign wt-viewjobdollar">
													
												</i>{{$row->amount}} Taka</span></li>
												<!-- <li><span><em><img src="{{asset('/')}}assets/images/flag/img-05.png" alt="img description"></em>United Emirates</span></li> -->
												<li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: level {{$row->level}} seller</span></li>
												<li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: {{$row->duration}} Days</span></li>
												<li><span><i class="fa fa-tag wt-viewjobtag"></i>Job ID: gy3yV2Vm5u{{$row->id}}</span></li>
												<!-- <li><a href="javascript:void(0);" class="wt-clicklike"><i class="fa fa-heart"></i> Click to Save</a></li> -->

												
												<li class="wt-btnarea"><a href="{{route('bid',['id'=>$row->id])}}" class="wt-btn">Bid</a></li>
								...
								{{-- <h3 class="text-danger text-center">No requests found</h3> --}}
								...
								<!-- <div class="wt-userlistinghold wt-userlistingholdvtwo">
									<div class="wt-userlistingcontent">
										...
										<div class="wt-viewjobholder">
											<ul>
												<li><span><i class="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
												<li><span><em><img src="{{asset('/')}}assets/images/flag/img-01.png" alt="img description"></em>United Emirates</span></li>
												<li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: Per Hour</span></li>
												<li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: 03 Months</span></li>
												<li><span><i class="fa fa-tag wt-viewjobtag"></i>Job ID: gy3yV2Vm5u</span></li>
												<li><a href="javascript:void(0);" class="wt-clicklike"><i class="fa fa-heart"></i> Click to Save</a></li>
									...
									<div class="wt-userlistingcontent">
										...
										<div class="wt-viewjobholder">
											<ul>
												...
												<li><span><em><img src="{{asset('/')}}assets/images/flag/img-03.png" alt="img description"></em>Canada</span></li>
												<li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: Per Fixed</span></li>
												<li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: 15 Days</span></li>
