                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 push-lg-2">
                    ...
                    <div class="wt-proposalholder">
                        ...
                        <div class="wt-proposalhead">
                            ...
                            <ul class="wt-userlisting-breadcrumb wt-userlisting-breadcrumbvtwo">
                                <li><span><!-- <i class="fa fa-dollar-sign"></i><i class="fa fa-dollar-sign"></i><i class="fa fa-dollar-sign"></i> --> Amount: {{$job->amount}} Taka</span></li>
                                <!-- <li><span><img src="{{asset('/')}}assets/images/flag/img-02.png" alt="img description">  United States</span></li> -->
                                <li><span><i class="far fa-folder"></i> Type: level {{$job->level}} seller</span></li>
                                <li><span><i class="far fa-clock"></i> Duration: {{$job->duration}} Days</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="wt-proposalamount-holder">
                        ...
                        <div class="wt-proposalamount accordion">
                            <form action="{{route('bid-submit')}}" method="post">
                                @csrf
                                <input type="hidden" name="job_id" value="{{$job->id}}">
                                <input type="hidden" name="buyer_id" value="{{$job->buyer_id}}">
                                <input type="hidden" name="seller_id" value="{{Auth::id()}}">
                                <div class="form-group">
                                    <span>( <i class="fa fa-dollar-sign"></i> )</span>
                                    <input required type="number" name="amount" class="form-control" placeholder="Enter Your Proposal Amount (Taka)">
                            ...
                            <div class="wt-formtheme wt-formproposal">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <input required style="height: 50px" type="number" name="duration" class="form-control" placeholder="I Can Finish This Project In ... Days">
                                    </div>
                                    <div class="form-group">
                                        <textarea required name="description" class="form-control" placeholder="Add Description*"></textarea>
                                    </div>
                                </fieldset>
                                <fieldset>
