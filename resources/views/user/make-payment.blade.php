            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="{{ route('make-payment.post') }}" method="post" class="require-validation"
                        ...
                        <div class='form-row row'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    {{-- <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ({{$amount}} BDT)</button> --}}
                                    <button class="btn btn-primary btn-lg btn-block" type="submit">{{$amount}} + {{$amount*.1}}(Service Charge) BDT</button>
