						...
						<div class="wt-jobdetailscontent">
							<div class="wt-userlistinghold wt-featured wt-proposalitem">
								...
								<div class="wt-rightarea wt-titlewithsearch">
									...
									@elseif($requestOrder->seller_id==Auth::id())
									<form action="{{route('order-completed')}}" method="POST" class=" wt-formtheme wt-formsearch">
										@csrf
										<input type="hidden" name="id" value="{{$requestOrder->id}}">
										<fieldset>
											<div class="form-group">
												...
												<!-- <a href="javascrip:void(0);" class="wt-searchgbtn" data-toggle="modal" data-target="#wt-projectmodalbox"><i class="fa fa-check"></i></a> -->
												<button onclick="return confirm('Have you delivered project to client?')" type="submit" class="wt-searchgbtn" type="submit"><i class="fa fa-check"></i></button> 
											</div>
										</fieldset>
									</form>
									@endif
